$(function(){
    ...
    function down(item){
        item.mouseenter(function(){
            ...
            $(this).find('.menu-hd').css({'borderColor':'#fff'});
            $(this).css({"background":"#ffffff"});
            $(this).find('b').css('transform-origin','50% 50%');
            $(this).find('b').css('transform','rotate(180deg)');
        })
        item.mouseleave(function(){
            $(this).find('.menu-bd').css('display','none');
            $(this).css({"background":"#f2f2f2"});
            $(this).find('b').css({'transform-origin':'50% 50%','transform':'rotate(360deg)'})
        })
    }
    var tb=$('.mytaobao');
    var scj=$('.favorite');
    ...
    var flag=true;
    var sidebg=$('.fpLift a');
    var color3=['#64C33','#FF0036','#EA5F8D','#0AA6E8','#64C333','#EA5F8D','#19C8A9','#FF0036']
